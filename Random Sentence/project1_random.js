...
window.onload = function(){
	...
	//i can add to these arrays using firstword.push() method, most likely comming from a prompt box 

	//swtich out this method for the clean_looping method we developed in class, pushed to the average length of all of the arrays 
	
	//setTimeout(function.....) look at the clean_loop file in class 3
